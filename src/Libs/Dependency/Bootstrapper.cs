...
namespace Libs.Dependency
{
    ...
    public class Bootstrapper
    {
        ...
        public Bootstrapper(IServiceCollection services, IModule[] modules, Action<IAspectConfiguration> aopConfigAction, IFinder finder)
        {
        ...
        /// <param name="aopConfigAction">Aop配置操作</param>
        /// <param name="finder">类型查找器</param>
        public static IServiceProvider Run(IServiceCollection services = null, IModule[] configs = null,
                Action<IAspectConfiguration> aopConfigAction = null, IFinder finder = null)
        {
        ...
        /// <param name="services">服务集合</param>
        /// <param name="configs">依赖配置</param>
        public static IServiceProvider Run(IServiceCollection services, params IModule[] configs)
        {
        ...
        public IServiceProvider Bootstrap()
        {
            ...
            return Ioc.DefaultContainer.Register(_services, RegisterServices, _modules);
        }
