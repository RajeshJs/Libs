...
namespace Libs.Dependency
{
    ...
    public static class Ioc
    {
        ...
        public static IContainer CreateContainer(params IModule[] modules)
        {
            ...
            container.Register(null, builder => builder.EnableAop(), modules);
            return container;
        }
        ...
        {
            DefaultContainer.Register(null, builder => builder.EnableAop(), modules);
        }
        ...
        /// <param name="modules">依赖配置</param>
        public static IServiceProvider Register(IServiceCollection services, params IModule[] modules)
        {
            return DefaultContainer.Register(services, builder => builder.EnableAop(), modules);
        }
